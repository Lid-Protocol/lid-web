    ...
    <FlexBox justifyContent="center" flexWrap="wrap">
      ...
      <Box>
        ...
        <Text
          ...
          lineHeight="1.5em"
        >
          LID Certified Presale offers the most secure method for new projects
          to do Initial Liquidity Offerings in the DeFi space. LID Protocol
          deploys automated, non-custodial smart contracts that trustlessly lock
          liquidity raised through LID presale dApps.
        </Text>

        <FlexBox justifyContent={['center', 'initial']}>
          <Button variant="white" mt={5} mr={4} mb={[4, 0]} href="/application">
            Learn More
          </Button>
        </FlexBox>
      </Box>
