    ...
    <ContentWrapper>
        ...
        <Box mr={[0, 0, 5]}>
          ...
          >
            ...
            <Text width={1} as="p" mt={5} mb={5} lineHeight="1.5em">
              ...
              change the DEX Presale landscape - that solution, is LID Certified
              Presales. LID Certified Presales takes advantage of the resale
              process with the Initial Liquidity Offering (ILO) model. Offering
              a secure Initial Liquidity Offering (ILO) presale to your
              potential investors is the first major step you can take in
              improving your presale success.
            </Text>
      ...
      <Box maxWidth={640} fontWeight={500} mt={[5.5, 5.5, 6.5]}>
        ...
        <Text lineHeight="1.5em" as="p">
          With a LID Certified Presale you&apos;re able to ensure the ETH raised
          during presale is trustlessly locked into a Smart Contract. Another
          advantage is the ability to customize the token distribution rate over
          a specified length of time. 5% flat in ETH raised, 1% of the
          project&apos;s native take goes directly to LID stakers.
        </Text>
      </Box>
      ...
      <ContentWrapper>
        ...
        >
          <List color="offBlack" fontWeight={500}>
            <List.Item mb={4.5}>
              Verifiable SC (Smart Contract) for your investors and team members
              to see.
            </List.Item>
            <List.Item mb={4.5}>
              A presale dApp to direct your investors to, that connects to your
              main website.
            </List.Item>
            <List.Item mb={4.5}>
